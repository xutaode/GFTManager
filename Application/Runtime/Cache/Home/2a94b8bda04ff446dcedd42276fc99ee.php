  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="index.html"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> 首页 </a> </li>
        <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> 账户管理</a> </li>
        <li class="bg_ly"> <a href="widgets.html"> <i class="icon-inbox"></i><span class="label label-success">101</span> 我的服务 </a> </li>
        <li class="bg_lo"> <a href="tables.html"> <i class="icon-th"></i> 交易管理</a> </li>
        <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> 结算管理</a> </li>
        <li class="bg_lo span3"> <a href="form-common.html"> <i class="icon-th-list"></i> 代收代付</a> </li>
        ...
        <li class="bg_lr"> <a href="error404.html"> <i class="icon-info-sign"></i> 报错</a> </li>
